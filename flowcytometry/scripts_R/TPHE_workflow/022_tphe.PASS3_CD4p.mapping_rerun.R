...
## load fSOM
fSOM <- readRDS("./results_R/fSOMs/TPHE/2018-11-14.fSOM_PASS3_CD4p_rerun.rds") # needs stored $transform.object

## generate counts only
newfcs.fromfsom.singlefolder(fSOM.object = fSOM,
                             meta.cluster = NULL,
                             FCS.paths = tphe.warped.files,
                             basefolder.name = "./data_modified/TPHE_warping/fSOM_PASS3_CD4p_rerun.clusters",
                             fcsfolder.name =  NULL,
