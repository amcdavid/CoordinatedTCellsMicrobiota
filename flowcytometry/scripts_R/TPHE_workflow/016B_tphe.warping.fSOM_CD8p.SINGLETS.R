...
warp.markers <- c("PERFORIN", "CD57", "CD28", "FOXP3", "CD197", "CD185", "CD31")
...
outDir = file.path("./data_modified/TPHE_warping", batch.name, "PERFORIN.CD57.CD28.FOXP3.CD197.CD185.CD31_warped_CD8p")
