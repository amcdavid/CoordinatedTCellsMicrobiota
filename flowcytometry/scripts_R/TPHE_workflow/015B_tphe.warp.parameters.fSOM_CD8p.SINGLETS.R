## define warp parameters on CD8+ subset
...
##
TPHE.CD8.warp.parameters <- readRDS("./results_R/FCS.transforms/TPHE/TPHE.warp.parameters.edit.rds")
...
TPHE.CD8.warp.parameters[[marker.name]]["monwrd"] <- FALSE
TPHE.CD8.warp.parameters[[marker.name]]["peakNr"] <- 1
TPHE.CD8.warp.parameters[[marker.name]]["clipRange"] <- 0.01
TPHE.CD8.warp.parameters[[marker.name]]["bwFac"] <- bwFac.set
...
densityplot(~ ., fset.downsample(test.set, 5000)[, channels[grep(marker.name, markers)]], filter = curv1Filter(channels[grep(marker.name, markers)], bwFac = bwFac.set))
TPHE.CD8.warp.parameters[[marker.name]]["monwrd"] <- FALSE
TPHE.CD8.warp.parameters[[marker.name]]["peakNr"] <- 2
TPHE.CD8.warp.parameters[[marker.name]]["clipRange"] <- 0.01
TPHE.CD8.warp.parameters[[marker.name]]["bwFac"] <- bwFac.set
...
saveRDS(TPHE.CD8.warp.parameters, "./results_R/FCS.transforms/TPHE/TPHE.CD8.warp.parameters.rds")
